...
class HomeScreenController @Inject constructor(
  ...
  override fun apply(events: Observable<UiEvent>): ObservableSource<UiChange> {
    ...
    return Observable.merge(
        ...
        showHelpButton(replayedEvents),
        hideHelpButton(replayedEvents))
  }
  ...
  private fun showHelpButton(events: Observable<UiEvent>): Observable<UiChange> {
    ...
    return Observables
        ...
        .filter { helpScreenEnabled -> helpScreenEnabled }
        .map { Ui::showHelpButton }
  }

  private fun hideHelpButton(events: Observable<UiEvent>): Observable<UiChange> {
    val screenCreates = events.ofType<ScreenCreated>()
    ...
    return Observables
        ...
        .filter { helpScreenEnabled -> helpScreenEnabled.not() }
        .map { Ui::hideHelpButton }
  }
}
