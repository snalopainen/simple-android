...
class PatientRepositoryAndroidTest {
  ...
  @Test
  fun verify_deleted_PrescribedDrugs_are_not_included_when_fetching_recent_patients() {
    val facilityUuid = testData.qaUserFacilityUuid()
    val recentPatient1 = savePatientWithPrescribedDrug(facilityUuid = facilityUuid)
    savePatientWithPrescribedDrug(facilityUuid = facilityUuid, deletedAt = Instant.now())
  ...
  fun verify_deleted_Appointments_are_not_included_when_fetching_recent_patients() {
    ...
    savePatientWithAppointment(facilityUuid = facilityUuid, deletedAt = Instant.now())
